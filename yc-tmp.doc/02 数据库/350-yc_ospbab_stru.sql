DROP TABLE IF EXISTS ycospbab_site;
CREATE TABLE ycospbab_site (
	id					VARCHAR(100)	NOT NULL	COMMENT 'ID',
	no	DECIMAL(10,0)	NULL	COMMENT '',
	region	VARCHAR(100)	 NULL	COMMENT '',
	vendor	VARCHAR(100)	 NULL	COMMENT '',
	designinginstitute	VARCHAR(100)	 NULL	COMMENT '',
	pointa	VARCHAR(100)	 NULL	COMMENT '',
	pointb	VARCHAR(100)	 NULL	COMMENT '',
	nameofcablecn	VARCHAR(100)	 NULL	COMMENT '',
	nameofcable	VARCHAR(100)	 NULL	COMMENT '',
	typeofcable	VARCHAR(100)	 NULL	COMMENT '',
	cores	DECIMAL(10,0)	NULL	COMMENT '',
	planninglength	DECIMAL(10,2)	 NULL	COMMENT '',
	constructionpriority	VARCHAR(100)	 NULL	COMMENT '',
	whetheritcanbecompleted	VARCHAR(100)	 NULL	COMMENT '',
	planningstatus	VARCHAR(100)	 NULL	COMMENT '',
	statusofpointaa	VARCHAR(100)	 NULL	COMMENT '',
	constructionperioda	VARCHAR(100)	 NULL	COMMENT '',
	coordinatea	VARCHAR(100)	 NULL	COMMENT '',
	statusofpointbb	VARCHAR(100)	 NULL	COMMENT '',
	constructionperiodb	VARCHAR(100)	 NULL	COMMENT '',
	coordinateb	VARCHAR(100)	 NULL	COMMENT '',
	foclengthafteradjustment	DECIMAL(10,2)	 NULL	COMMENT '',
	foclengthvar	DECIMAL(10,2)	 NULL	COMMENT '',
	whethertheendtoend	VARCHAR(100)	 NULL	COMMENT '',
	whethertoplot	VARCHAR(100)	 NULL	COMMENT '',
	whethertorevisedrawings	VARCHAR(100)	 NULL	COMMENT '',
	designroutinglength	DECIMAL(10,2)	 NULL	COMMENT '',
	relaysectioninvestment	VARCHAR(100)	 NULL	COMMENT '',
	requiredquantityofrta	VARCHAR(100)	 NULL	COMMENT '',
	submittedquantityofrta	VARCHAR(100)	 NULL	COMMENT '',
	approvedquantityofrta	VARCHAR(100)	 NULL	COMMENT '',
	levelrowlengthobtained	DECIMAL(10,2)	 NULL	COMMENT '',
	fullrowlength	DECIMAL(10,2)	 NULL	COMMENT '',
	lengthunderconstruction	DECIMAL(10,3)	 NULL	COMMENT '',
	completedlengthofpro	DECIMAL(10,3)	 NULL	COMMENT '',
	completedlength	DECIMAL(10,3)	 NULL	COMMENT '',
	whetherrelaysectioncanbe	VARCHAR(100)	 NULL	COMMENT '',
	whetherrelaysectionhasbe	VARCHAR(100)	 NULL	COMMENT '',
...
DROP TABLE IF EXISTS ycospbab_site_column;
CREATE TABLE ycospbab_site_column
(

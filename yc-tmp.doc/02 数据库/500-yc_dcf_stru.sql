...
-- DC所有字段（包括未使用的）
-- 
DROP TABLE IF EXISTS ycdcf_site_column;
CREATE TABLE ycdcf_site_column
(
...
-- 配置参数操作记录表
-- 
DROP TABLE IF EXISTS ycdcf_cfg_opera;
CREATE TABLE ycdcf_cfg_opera
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
	menu_id				VARCHAR(64)		NOT NULL	COMMENT 'Menu name',
	site_id				VARCHAR(64)		NOT NULL	COMMENT 'Site ID',
	column_id			VARCHAR(64)		NOT NULL	COMMENT 'Param ID',
	opt_type			CHAR(1)			NOT NULL	COMMENT 'Operate Type',
	before_value		VARCHAR(255)		NULL	COMMENT 'Before Value',
	after_value			VARCHAR(255)		NULL	COMMENT 'After Value',
...
-- Operate Type(1-Single modification，2-Batch import)


--
-- 配置参数修改邮件通知用户表
-- 
DROP TABLE IF EXISTS ycdcf_cfg_mail;
CREATE TABLE ycdcf_cfg_mail
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
	...
	remarks				VARCHAR(255)		NULL	COMMENT 'remarks',
	PRIMARY KEY (id)
) COMMENT = '配置参数修改邮件通知用户表';


--
-- 菜单与配置参数对应关系表
-- 
DROP TABLE IF EXISTS ycdcf_db_column;
CREATE TABLE ycdcf_db_column
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
	menu_id				VARCHAR(64)		NOT NULL	COMMENT 'Menu name',
	site_column_id		VARCHAR(64)		NOT NULL	COMMENT 'Column name',
	create_by			VARCHAR(64)			NULL	COMMENT 'Creator',
	create_date			DATETIME			NULL	COMMENT 'CreateDate',
	update_by			VARCHAR(64)			NULL	COMMENT 'Updater',
	update_date			DATETIME			NULL	COMMENT 'UpdateDate',
...
DROP TABLE IF EXISTS ycdcf_db_compare;
CREATE TABLE ycdcf_db_compare
(
	id					VARCHAR(64)			NOT NULL	COMMENT 'ID',
	phsiteid			VARCHAR(125)		NOT NULL	COMMENT 'Site ID',
	parameter			VARCHAR(125)		NOT NULL	COMMENT 'Parameter',
	databasea			VARCHAR(125)		NOT NULL	COMMENT 'DatabaseA',
	databaseb			VARCHAR(125)		NOT NULL	COMMENT 'DatabaseB',
	PRIMARY KEY (id)
) COMMENT = 'DBcompare';
...
-- 【未使用】DC行筛选过滤策略父表
-- 
DROP TABLE IF EXISTS ycdcf_site_rowf;
CREATE TABLE ycdcf_site_rowf
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
...
-- 【未使用】DC行筛选过滤策略子表
-- 
DROP TABLE IF EXISTS ycdcf_site_rowf_column;
CREATE TABLE ycdcf_site_rowf_column
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
...
-- 【未使用】DC列筛选过滤策略父表
-- 
DROP TABLE IF EXISTS ycdcf_site_colf;
CREATE TABLE ycdcf_site_colf
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
	filter_name			VARCHAR(100)	NOT NULL	COMMENT 'FilterName',
	shared				CHAR(1)			NOT NULL	DEFAULT '1'	COMMENT 'Shared(1-private 2-public)',
...
-- 【未使用】DC列筛选过滤策略子表
-- 
DROP TABLE IF EXISTS ycdcf_site_colf_column;
CREATE TABLE ycdcf_site_colf_column
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
	filter_id			VARCHAR(64)		NOT NULL	COMMENT 'FilterID',
	column_id			VARCHAR(64)		NOT NULL	COMMENT 'ColumnID',
...
-- 【未使用】个人配置信息表
-- 
DROP TABLE IF EXISTS ycdcf_my_config;
CREATE TABLE ycdcf_my_config
(
...
--
-- 【未使用】角色与MILESTONE字段权限配置信息表
-- 
DROP TABLE IF EXISTS ycdcf_role_field;
CREATE TABLE ycdcf_role_field
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
...
-- 【未使用】报表定制表
-- 
DROP TABLE IF EXISTS ycdcf_rpt_design;
CREATE TABLE ycdcf_rpt_design
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
...
-- 【未使用】报表定制字段
-- 
DROP TABLE IF EXISTS ycdcf_rpt_design_colunm;
CREATE TABLE ycdcf_rpt_design_colunm
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',
...
-- 【未使用】Milestone操作记录表
-- 
DROP TABLE IF EXISTS ycdcf_miles_opera;
CREATE TABLE ycdcf_miles_opera
(
	id					VARCHAR(64)		NOT NULL	COMMENT 'ID',

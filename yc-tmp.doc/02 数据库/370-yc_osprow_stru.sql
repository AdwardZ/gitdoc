DROP TABLE IF EXISTS ycosprow_site;
CREATE TABLE ycosprow_site (
	id					VARCHAR(100)	NOT NULL	COMMENT 'ID',
	no	DECIMAL(10,0)	NULL	COMMENT '',
	region	VARCHAR(100)	 NULL	COMMENT '',
	vendor	VARCHAR(100)	 NULL	COMMENT '',
	ditoid	VARCHAR(100)	 NULL	COMMENT '',
	typeofcable	VARCHAR(100)	 NULL	COMMENT '',
	province	VARCHAR(100)	 NULL	COMMENT '',
	dpwhdeo	VARCHAR(100)	 NULL	COMMENT '',
	lgu	VARCHAR(100)	 NULL	COMMENT '',
	permitcategory	VARCHAR(100)	 NULL	COMMENT '',
	location	VARCHAR(100)	 NULL	COMMENT '',
	rowdistance	DECIMAL(10,2)	 NULL	COMMENT '',
	applydate	DATETIME	NULL	COMMENT '',
	securedate	DATETIME	NULL	COMMENT '',
	duration	DECIMAL(10,0)	NULL	COMMENT '',
	durationreference	DECIMAL(10,0)	NULL	COMMENT '',
	siastatus	VARCHAR(100)	 NULL	COMMENT '',
	delayreason	VARCHAR(100)	 NULL	COMMENT '',
	siaremark	VARCHAR(100)	 NULL	COMMENT '',
	supportfromdito	VARCHAR(100)	 NULL	COMMENT '',
...
DROP TABLE IF EXISTS ycosprow_site_column;
CREATE TABLE ycosprow_site_column
(

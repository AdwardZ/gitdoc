DROP TABLE IF EXISTS ycospsia_site;
CREATE TABLE ycospsia_site (
	id					VARCHAR(100)	NOT NULL	COMMENT 'ID',
	no	DECIMAL(10,0)	NULL	COMMENT '',
	region	VARCHAR(100)	 NULL	COMMENT '',
	vendor	VARCHAR(100)	 NULL	COMMENT '',
	design	VARCHAR(100)	 NULL	COMMENT '',
	nameofa	VARCHAR(100)	 NULL	COMMENT '',
	apointtype	VARCHAR(100)	 NULL	COMMENT '',
	bpoint	VARCHAR(100)	 NULL	COMMENT '',
	bpointtype	VARCHAR(100)	 NULL	COMMENT '',
	accesstype	VARCHAR(100)	 NULL	COMMENT '',
	cablesectionname	VARCHAR(100)	 NULL	COMMENT '',
	cabletype	VARCHAR(100)	 NULL	COMMENT '',
	fibercores	VARCHAR(100)	 NULL	COMMENT '',
	lengthplanning	VARCHAR(100)	 NULL	COMMENT '',
	priority	VARCHAR(100)	 NULL	COMMENT '',
	astatus	DATETIME	 NULL	COMMENT '',
	agps	VARCHAR(100)	 NULL	COMMENT '',
	bstatus	VARCHAR(100)	 NULL	COMMENT '',
	bgps	VARCHAR(100)	 NULL	COMMENT '',
	endtoeedsulutionwithosp	VARCHAR(100)	 NULL	COMMENT '',
	drwaingdone	VARCHAR(100)	 NULL	COMMENT '',
	drwaingchanged	VARCHAR(100)	 NULL	COMMENT '',
	planninglength	VARCHAR(100)	 NULL	COMMENT '',
	budget	VARCHAR(100)	 NULL	COMMENT '',
	rtaplanning	VARCHAR(100)	 NULL	COMMENT '',
	rtaissued	VARCHAR(100)	 NULL	COMMENT '',
	rtasecured	VARCHAR(100)	 NULL	COMMENT '',
	levelrowsecured	VARCHAR(100)	 NULL	COMMENT '',
	rfc	VARCHAR(100)	 NULL	COMMENT '',
	lengthunderconstruction	VARCHAR(100)	 NULL	COMMENT '',
	completedlengthofprop	VARCHAR(100)	 NULL	COMMENT '',
	completedlength	VARCHAR(100)	 NULL	COMMENT '',
	wherelayseccanacc	VARCHAR(100)	 NULL	COMMENT '',
	wherelaysechasacc	VARCHAR(100)	 NULL	COMMENT '',
	constructionobstruction	VARCHAR(100)	 NULL	COMMENT '',
	mainbname	VARCHAR(100)	 NULL	COMMENT '',
	mainbstatus	VARCHAR(100)	 NULL	COMMENT '',
	mainbgps	VARCHAR(100)	 NULL	COMMENT '',
	mainfibercores	VARCHAR(100)	NULL	COMMENT '',
	mainsolutionissued	VARCHAR(100)	 NULL	COMMENT '',
	mainresourceavailable	VARCHAR(100)	 NULL	COMMENT '',
	maintdapproval	VARCHAR(100)	 NULL	COMMENT '',
	mainporeleasedbytd	VARCHAR(100)	 NULL	COMMENT '',
	mainremark	VARCHAR(100)	 NULL	COMMENT '',
	backupbname	VARCHAR(100)	 NULL	COMMENT '',
	backupbstatus	VARCHAR(100)	 NULL	COMMENT '',
	backupbgps	VARCHAR(100)	 NULL	COMMENT '',
	backupfibercores	VARCHAR(100)	 NULL	COMMENT '',
	backupsolution	VARCHAR(100)	 NULL	COMMENT '',
	backupresource	VARCHAR(100)	 NULL	COMMENT '',
	backuptdapproval	VARCHAR(100)	 NULL	COMMENT '',
	backupporeleased	VARCHAR(100)	 NULL	COMMENT '',
	backupremark	VARCHAR(100)	NULL	COMMENT '',
...
DROP TABLE IF EXISTS ycospsia_site_column;
CREATE TABLE ycospsia_site_column
(
